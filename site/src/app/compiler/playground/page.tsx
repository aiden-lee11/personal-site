...
export const metadata: Metadata = {
  ...
  description:
    "Write LC (or any layer below it) and step through my 7-stage C++ compiler — LC → LB → LA → IR → L3 → L2 → L1 → x86-64 — with live pass toggles and optimized-vs-unoptimized diffs.",
};
    ...
    <div>
      <header className="mb-12">
        ...
        <p className="mt-4 text-[color:var(--muted)] max-w-2xl leading-relaxed">
          ...
          down run in your browser as WebAssembly — the exact stages I wrote; the
          top LC and LB stages lower server-side via the CS 322 instructor&apos;s
          reference binaries. The final panel is the assembly your CPU would run.
        </p>
      </header>
